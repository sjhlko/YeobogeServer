 ...
 * {@link IndividualRecommendationResponse}에 해당 데이터를 추가하는 로직을
 * 추상화하기 위한 인터페이스
 */
public interface IndividualRecommender {
    /**
     ...
     */
    void addRecommendationsToResponse(IndividualRecommendationResponse response, CountDownLatch latch);
}
