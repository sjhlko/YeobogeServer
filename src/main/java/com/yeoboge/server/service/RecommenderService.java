...
public interface RecommenderService {
     ...
     * {@link RecommendationResponse}에 담아 반환함.
     *
     * @param userId 조회할 사용자 ID
     * @return 카테고리 별 추천 보드게임 목록 관련 메타데이터가 담긴 {@link RecommendationResponse}
     */
    RecommendationResponse getSingleRecommendation(Long userId);
}
