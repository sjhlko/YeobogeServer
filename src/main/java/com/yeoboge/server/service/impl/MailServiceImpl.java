...
public class MailServiceImpl implements MailService {
    ...
    public String makeHtml(User receiver){
        return  "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head>\n" +
                ...
                "}\n" +
                "\n" +
                "table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_heading_1 .v-container-padding-padding { padding: 50px 10px 0px 20px !important; } #u_content_heading_1 .v-font-size { font-size: 34px !important; } #u_content_text_1 .v-container-padding-padding { padding: 20px !important; } #u_content_text_1 .v-text-align { text-align: justify !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px 20px 50px !important; } #u_content_text_2 .v-line-height { line-height: 200% !important; } }\n" +
                "    </style>\n" +
                "  \n" +
                "  \n" +
                "\n" +
                ...
                "    \n" +
                "\n" +
                "<div class=\"u-row-container\" style=\"padding: 0px;background-color: #373d42;\">\n" +
                ...
                "      \n" +
                "      <img align=\"center\" border=\"0\" src=\"https://techcrunch.com/wp-content/uploads/2016/07/gettyimages-479960728.jpg?w=680\" alt=\"image\" title=\"image\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;\" width=\"600\">\n" +
                "      \n" +
                "    </td>\n" +
                "  </tr>\n" +
                "</tbody></table>\n" +
                ...
                "        \n" +
                "  <h1 class=\"v-text-align v-line-height v-font-size\" style=\"margin: 0px; color: #1e2655; line-height: 140%; text-align: left; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 25px; font-weight: 400;\">"+ this.subject +"</h1>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                "  </tbody>\n" +
                ...
                "  <!--[if mso]><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"https://www.unlayer.com\" style=\"height:37px; v-text-anchor:middle; width:192px;\" arcsize=\"11%\"  stroke=\"f\" fillcolor=\"#1e2655\"><w:anchorlock/><center style=\"color:#FFFFFF;font-family:'Montserrat',sans-serif;\"><![endif]-->  \n" +
                "    <a href=\"https://www.unlayer.com\" target=\"_blank\" class=\"v-button v-font-size\" style=\"box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #1e2655; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;\">\n" +
                "      \n" +
                "    </a>\n" +
                ...
                "\n" +
                "\n" +
                "<div class=\"u-row-container\" style=\"padding: 0px;background-color: #282a38;\">\n" +
                "  <div class=\"u-row\" style=\"Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;\">\n" +
                "    <div style=\"border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;\">\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 200%;\"><span style=\"text-decoration: underline; font-size: 14px; line-height: 28px;\">heyBoardGame</span>&nbsp; |&nbsp;<span style=\"font-size: 14px; line-height: 28px;\"> </span><span style=\"text-decoration: underline; font-size: 14px; line-height: 28px;\">yeoboge</span><span style=\"font-size: 14px; line-height: 28px;\">&nbsp; |&nbsp; </span><span style=\"text-decoration: underline; font-size: 14px; line-height: 28px;\">hongik university</span></p>\n" +
                "\n" +
                "<p style=\"font-size: 14px; line-height: 200%;\">여보게 문의 메일\uD83D\uDCE8<span style=\"text-decoration: underline; font-size: 14px; line-height: 28px;\"><strong>heyboardgame@gmail.com</strong></span>.<br></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
